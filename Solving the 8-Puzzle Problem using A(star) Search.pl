...
# Map to store goal positions of each tile
goal_pos = {}
...
def solve_8_puzzle(start):
    ...
    while pq:
        current_f, current_g, current_board = heapq.heappop(pq)
        ...
        for i in range(4):
            ...
            if 0 <= nx < 3 and 0 <= ny < 3:
                # Convert tuple -> list for swapping
                ...
                # Same optimization as C++ version
...
def main():
    ...
    goal_map()  # Initialize goal positions
